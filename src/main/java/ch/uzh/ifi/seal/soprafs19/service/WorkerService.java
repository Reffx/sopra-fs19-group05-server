...
public class WorkerService {
    ...
    public ResponseEntity<List<Integer>> highlightField(int fieldNum, long gameId) {
        ...
        if(x1 <= 4 && y1 <= 4 && x1 >= 0 && y1 >= 0) {
            ...
            if(highlight1.getHeight() != 4 && highlight1.getOccupier() == null && Math.abs(intitFieldHeight - highlight1.getHeight()) <= 1){
        ...
        if(x2 <= 4 && y2 <= 4 && x2 >= 0 && y2 >= 0) {
            ...
            if (highlight2.getHeight() != 4 && highlight2.getOccupier() == null && Math.abs(intitFieldHeight - highlight2.getHeight()) <= 1) {
        ...
        if(x3 <= 4 && y3 <= 4 && x3 >= 0 && y3 >= 0) {
            ...
            if (highlight3.getHeight() != 4 && highlight3.getOccupier() == null && Math.abs(intitFieldHeight - highlight3.getHeight()) <= 1) {
        ...
        if(x4 <= 4 && y4 <= 4 && x4 >= 0 && y4 >= 0) {
            ...
            if (highlight4.getHeight() != 4 && highlight4.getOccupier() == null && Math.abs(intitFieldHeight - highlight4.getHeight()) <= 1) {
        ...
        if(x5 <= 4 && y5 <= 4 && x5 >= 0 && y5 >= 0) {
            ...
            if (highlight5.getHeight() != 4 && highlight5.getOccupier() == null && Math.abs(intitFieldHeight - highlight5.getHeight()) <= 1) {
        ...
        if(x6 <= 4 && y6 <= 4 && x6 >= 0 && y6 >= 0) {
            ...
            if (highlight6.getHeight() != 4 && highlight6.getOccupier() == null && Math.abs(intitFieldHeight - highlight6.getHeight()) <= 1) {
        ...
        if(x7 <= 4 && y7 <= 4 && x7 >= 0 && y7 >= 0) {
            ...
            if (highlight7.getHeight() != 4 && highlight7.getOccupier() == null && Math.abs(intitFieldHeight - highlight7.getHeight()) <= 1) {
        ...
        if(x8 <= 4 && y8 <= 4 && x8 >= 0 && y8 >= 0) {
            ...
            if (highlight8.getHeight() != 4 && highlight8.getOccupier() == null && Math.abs(intitFieldHeight - highlight8.getHeight()) <= 1) {
